...
from indexer.inverted_index import Posting, get_postings, get_document_count, get_url, load_index_full
...
if __name__ == "__main__":
    ...
    with open("index/main_inverted_index.nidx", "rb") as f:
        idx = load_index_full(f)
        term_offsets = idx.save(Path("index/temp"))
